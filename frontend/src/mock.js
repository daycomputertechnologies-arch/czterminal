...
export const stakingOptions = [
  {
    ...
    features: ["No lock period", "Withdraw anytime", "Lower APY", "Great for liquidity"]
  },
  {
    type: "Fixed Staking",
    apy: "18-25%",
    ...
    features: ["Fixed lock period", "Higher APY", "Enhanced rewards", "Ecosystem support"]
  }
];
...
export const features = [
  {
    ...
    description: "Strategic token burns triggered by market milestones create scarcity and long-term value.",
    icon: "Flame"
  },
  {
    title: "Flexible Staking",
    description: "Earn rewards with complete flexibility - stake and unstake whenever you need.",
    icon: "Coins"
  },
  {
    title: "Holder Rewards",
    description: "Regular airdrops and community rewards for loyal token holders.",
    icon: "Gift"
  },
  {
